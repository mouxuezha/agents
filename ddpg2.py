...
class DDPG2:
    """docstring for DDPG"""
    def __init__(self, env,buffer,index):
        ...
        self.actor_network = ActorNetwork(self.sess,self.state_dim,self.action_dim,self.kind)
        ...
        # self.raw_state_save = np.array([0,0,0,0,0.6,0,0]).reshape(1,7)
    ...
    def reset_agent(self,**kargs):
        ...
        if 'location' in kargs:
            ...
            try:
                ...
                os.remove(location + '/buffer_2dim'+'.pkl')
